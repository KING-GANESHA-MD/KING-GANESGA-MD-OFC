...
const sessdata = config.SESSION_ID.replace("KING-GANESHA-MD=", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `⚡*WELCOME, KING-GANESHA-MD USER!* ⚡  


*SYSTEM STATUS: ACTIVE | KEEP EXPLORING WITH KING-GANESHA-MD!* 🚀
...
[>] YOUR PREFIX KEY: ➜ [ ${PREFIX} ] 🖥️  


[>] SUPPORT DEVELOPMENT - STAR THE REPO: 🌟 :
https://github.com/your-username/KING-GANESHA-MD  
...
*𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐊𝐈𝐍𝐆 𝐆𝐀𝐍𝐄𝐒𝐇𝐀-𝐌𝐃 👨‍💻**`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/TqrthF8S/temp-image.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94716682532','94714184446');
...
*𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐊𝐈𝐍𝐆 𝐆𝐀𝐍𝐄𝐒𝐇𝐀-𝐌𝐃 👨‍💻*`,
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("94716682532")){
  if(isReact) return
  m.react("😁")
   }
  //==========public react============//
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("KING-GANESHA-MD STARTED ✅");
  });
